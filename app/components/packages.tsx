                                ...
                                .map((items, i) => (
                                    <div key={i} className="mb-4">
                                        <div className="relative group">
                                            ...
                                            <div className="absolute bottom-0 w-[100%] bg-neutral-900 text-white p-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex gap-1 items-center">
                                                        <GoDotFill size={20} className="text-red-700" />
                                                        <p className="text-md">5 Days, 4 Nights</p>
                                                    </div>
                                                    <p className="text-md">$500/Person</p>
                                                </div>
                                                <h4 className="text-2xl font-bold pt-2">Explore the Beauty of {items.place}</h4>
                                                <div className="flex items-center justify-between">
